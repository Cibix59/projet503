...
/**
 * Classe correspondant au handler sur le contexte 'accueil.html'.
 */
class AccueilSimpleHandler implements HttpHandler {

    public void handle(HttpExchange t) {
        String reponse = """
            <h1>Bienvenue sur la page d'accueil TARE !</h1>
            <form method="get" action="http://localhost:8080/commande">
